class PluralizePluralData{
  static Map<RegExp, String> pluralRulesData = {
    ...
    RegExp(r'([^l]ias|[aeiou]las|[ejzr]as|[iu]am)$', caseSensitive: false): r'$0',
    RegExp(r'(alumn|syllab|vir|radi|nucle|fung|cact|stimul|termin|bacill|foc|uter|loc|strat)(?:us|i)$', caseSensitive: false): r'$0i',
    ...
    RegExp(r'(agend|addend|millenni|dat|extrem|bacteri|desiderat|strat|candelabr|errat|ov|symposi|curricul|automat|quor)(?:a|um)$', caseSensitive: false): r'$0a',
    RegExp(r'(apheli|hyperbat|periheli|asyndet|noumen|phenomen|criteri|organ|prolegomen|hedr|automat)(?:a|on)$', caseSensitive: false): r'$0a',
